...
ships_init[0, :] = np.array([0, 1558.8])
ships_goal[0, :] = np.array([0, 200])
ships_speed[0] = 5
ships_head[0] = -90
ships_length[0] = 50

ships_init[1, :] = np.array([-800, 200])
ships_goal[1, :] = np.array([550, 979.42])
ships_speed[1] = 5
ships_head[1] = 30
ships_length[1] = 50

ships_init[2, :] = np.array([800, 200])
ships_goal[2, :] = np.array([-550, 979.42])
ships_speed[2] = 5
ships_head[2] = 150
ships_length[2] = 50
