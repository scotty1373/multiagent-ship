...
class RoutePlan(gym.Env, EzPickle):
    ...
    def step(self, action_sample: np.array):
        ...
        speed_test = 8
        self.ship.position[0] = math.cos(self.ship.angle)*speed_test + self.ship.position[0]
        self.ship.position[1] = math.sin(self.ship.angle)*speed_test + self.ship.position[1]
